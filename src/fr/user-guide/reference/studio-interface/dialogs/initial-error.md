---
permalink: /fr/user-guide/reference/studio-interface/dialogs/initial-error/
...
ui:
  ...
  backLabel: Dialogs
  overview: >
    Le dialog Initial error apparaît quand Studio ne parvient pas à finir son démarrage.
  controls:
    - label: Error details
