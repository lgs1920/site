---
permalink: /fr/user-guide/reference/studio-interface/dialogs/geocoding/
...
ui:
  ...
  backLabel: Dialogs
  overview: >
    Le dialog Geocoding est la surface de recherche de lieu. Il aide à transformer un nom de lieu ou une coordonnée en résultat cartographique.
  controls:
    - label: Search field
