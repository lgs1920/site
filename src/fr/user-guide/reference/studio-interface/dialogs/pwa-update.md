---
permalink: /fr/user-guide/reference/studio-interface/dialogs/pwa-update/
...
ui:
  ...
  backLabel: Dialogs
  overview: >
    Le dialog PWA update apparaît quand le navigateur propose une nouvelle version d'app ou une installation.
  controls:
