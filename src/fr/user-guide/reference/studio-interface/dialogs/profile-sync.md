---
permalink: /fr/user-guide/reference/studio-interface/dialogs/profile-sync/
...
ui:
  ...
  backLabel: Dialogs
  overview: >
    Le dialog Profile sync gère l'état de profil navigateur que Studio utilise pour le comportement de synchronisation.
  controls:
    - label: Sync switch
      icon: link
      type: Switch
