...
export const renderStatsPage = ({
    ...
    <p class="stats-status" data-stats-status role="status" aria-live="polite">${escapeHtml(pageLabels.loading)}</p>
    ...
    <div class="stats-meta">
        <p id="stats-description" class="stats-updated" data-stats-updated hidden></p>
