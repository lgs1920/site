---
permalink: /user-guide/reference/studio-interface/dialogs/video-download/
...
ui:
  ...
  backLabel: Dialogs
  overview: >
    The Video download dialog appears after a capture is ready. It gives the user a last check before downloading or sharing the recorded output.
  controls:
    - label: Preview area
