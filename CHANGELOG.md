...
## 2026-07-22 — `pending` — Add site rules and commit changelog
...
## 2026-07-22 — `pending` — Update homepage access copy and default dark theme
...
## 2026-07-22 — `d35db5b` — Update bilingual homepage roadmap and access copy
